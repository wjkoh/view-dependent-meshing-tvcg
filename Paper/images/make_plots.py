...
def comma_sep(x, pos):  # formatter function takes tick label and tick position
...
if __name__ == '__main__':
    ...
    y_format = tkr.FuncFormatter(comma_sep)  # make formatter
    ax.right_ax.yaxis.set_major_formatter(y_format)  # set formatter to needed axis
