...
%[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{photo}}]
{James F.~O'Brien}
is a professor at the University of California, Berkeley. He received his doctorate in Computer Science from the Georgia Institute of Technology. He is generally interested in most areas of computer graphics and animation. His primary area of research involves the physically based simulation of complex deformable and fluid systems to generate motion for use in computer animation.
\end{IEEEbiography}
