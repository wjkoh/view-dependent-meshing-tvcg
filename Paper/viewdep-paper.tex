...
E-mail: \{wjkoh,narain,job\}@berkeley.edu.}
...
From the camera's perspective, however, wrinkles and folds that are very distant or foreshortened will appear extremely small in the final image.
...
\begin{IEEEbiography}
[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{woojong_koh.jpg}}]
...
\begin{IEEEbiography}
[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{rahul_narain.jpg}}]
{Rahul Narain}
...
\begin{IEEEbiography}
[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{james_f_obrien.jpg}}]
{James F.~O'Brien}
